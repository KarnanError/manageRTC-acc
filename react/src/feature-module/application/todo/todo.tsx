            ...
            <div className="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
              ...
              <div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                <div className="d-flex align-items-center border rounded p-1 me-2">
                  <button
                    className={`btn btn-icon btn-sm ${viewMode === "list"
                  ...
                  <button
                    className={`btn btn-icon btn-sm ${viewMode === "grid"
                        ? "active bg-primary text-white"
                        : ""
                      }`}
                    ...
                    <div className="dropdown me-2">
                      ...
                      <ul className="dropdown-menu dropdown-menu-end p-3">
                        <li>
                          <Link
                            to="#"
                            className={`dropdown-item rounded-1 ${selectedPriority === "all" ? "active" : ""
                              }`}
                            onClick={(e) => {
                              e.preventDefault();
                        ...
                        <li>
                          <Link
                            to="#"
                            className={`dropdown-item rounded-1 ${selectedPriority === "high" ? "active" : ""
                              }`}
                            onClick={(e) => {
                              e.preventDefault();
                        ...
                        <li>
                          <Link
                            to="#"
                            className={`dropdown-item rounded-1 ${selectedPriority === "medium" ? "active" : ""
                              }`}
                            onClick={(e) => {
                              e.preventDefault();
                        ...
                        <li>
                          <Link
                            to="#"
                            className={`dropdown-item rounded-1 ${selectedPriority === "low" ? "active" : ""
                              }`}
                            onClick={(e) => {
                              e.preventDefault();
